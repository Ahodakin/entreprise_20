                              ...
                              <div class="table-responsive-sm">
                                 <table class="table">
                                    ...
                                    <?php
                                       ...
                                       $req=$cnx->query("select * from utilisateurs where type='C' limit $debut, $nbre_elt_par_page " );
                                       ...
                                       <tr>
                                          ...
                                          <td>'.$result[3].'</td>
                                          <td>'.$result[4].'</td>
                                          <td> <a href="delete_member.php?id='.$result[0].'&type='.$result[12].'" class="btn btn-danger text-white"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                       </tr>';}
                                       ?>
