   ...
   <div class="row">
      ...
      <div class="col-9  wow fadeIn" data-wow-delay=".5s">
         <?php 
            ...
            $req=$cnx->prepare("select * from messages where emetteur=:ds and statMesEmett='1'");
                              ...
                              $_SESSION['num']=$result[1];
                               ...
                               echo'
                                 <tr>
                                    ...
                                    <td>'.$result[2].'</td>
                                    <td>'.$result[3].'</td>
                                     <td>'.recherche($result[6]).'</td>
                                    <td>'.$result[4].'</td>
                                    <td>'.$result[5].'</td>
                                    <td> <a href="delete_message_sent.php?id='.$result[0].'&type='.$result[6].'" class="btn btn-danger text-white btn-sm" title="supprimer"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                 </tr>';
                           }
                        }
                        else
